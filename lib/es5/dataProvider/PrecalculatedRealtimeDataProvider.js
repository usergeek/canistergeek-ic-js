...
const PrecalculatedRealtimeDataProvider = (props) => {
    ...
    (0, use_custom_compare_1.useCustomCompareEffect)(() => {
        setPrecalculatedData(PrecalculatedRealtimeDataProviderCalculator_1.PrecalculatedRealtimeDataProviderCalculator.getPrecalculatedData(dataContext.dataHourly, dataContext.dataBlackhole, configurationContext.configuration));
