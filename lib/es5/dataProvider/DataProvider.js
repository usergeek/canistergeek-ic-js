    ...
    const collectCanisterMetrics = (0, react_1.useCallback)(async (params) => {
        try {
            ...
            const promises = lodash_1.default.map(params.canisterIds, async (canisterId) => {
                const canisterActor = CanistergeekService_1.CanistergeekService.createCanistergeekCanisterActor(canisterId, props.identity, props.host, props.httpAgent);
...
const fetchCanisterHourlyDataAndUpdateState = async (params, identity, host, httpAgent) => {
    const canisterActor = CanistergeekService_1.CanistergeekService.createCanistergeekCanisterActor(params.canisterId, identity, host, httpAgent);
...
const fetchCanisterDailyDataAndUpdateState = async (params, identity, host, httpAgent) => {
    const canisterActor = CanistergeekService_1.CanistergeekService.createCanistergeekCanisterActor(params.canisterId, identity, host, httpAgent);
