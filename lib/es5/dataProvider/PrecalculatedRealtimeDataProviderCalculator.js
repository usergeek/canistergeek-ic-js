...
const getCyclesMetricWrapperFromBlackholeData = (data, configuration) => {
    var _a, _b, _c, _d;
    if (data) {
        return getMetricWrapperFromValue(data.cycles, (_b = (_a = configuration.metrics) === null || _a === void 0 ? void 0 : _a.cycles) === null || _b === void 0 ? void 0 : _b.metricsFormat, (_d = (_c = configuration.metrics) === null || _c === void 0 ? void 0 : _c.cycles) === null || _d === void 0 ? void 0 : _d.thresholds);
    }
};
const getMemoryMetricWrapperFromBlackholeData = (data, configuration) => {
...
const getPrecalculatedData = (dataHourly, dataBlackhole, configuration) => {
    return lodash_1.default.mapKeys(lodash_1.default.compact(lodash_1.default.map(configuration.canisters, (canister) => {
        const canisterId = canister.canisterId;
        const hourlyMetricsData = lodash_1.default.last(dataHourly[canisterId]);
