...
export declare const PrecalculatedRealtimeDataProviderCalculator: {
    getPrecalculatedData: (dataHourly: ContextDataHourly, dataBlackhole: ContextDataBlackhole, configuration: Configuration) => PrecalculatedData;
    ...
    getCyclesMetricWrapperFromBlackholeData: (data: CanisterBlackholeData | undefined, configuration: Configuration) => MetricWrapper<number> | undefined;
    getMemoryMetricWrapperFromBlackholeData: (data: CanisterBlackholeData | undefined, configuration: Configuration) => MetricWrapper<number> | undefined;
