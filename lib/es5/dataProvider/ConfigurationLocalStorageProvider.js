...
const keyValueStore = KeyValueStoreFacade_1.KeyValueStoreFacade.createStore("canistergeek__");
...
const readConfigurationFromLocalStorage = () => {
    try {
        const parsed = keyValueStore.get(LOCAL_STORAGE__KEY__CONFIGURATION);
