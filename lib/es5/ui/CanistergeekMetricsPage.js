...
exports.CanistergeekMetricsPage = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const antd_1 = require("antd");
const react_router_dom_1 = require("react-router-dom");
const principal_1 = require("@dfinity/principal");
const MetricsSummarySectionComponent_1 = require("./MetricsSummarySectionComponent");
const MetricsCanisterSectionComponent_1 = require("./MetricsCanisterSectionComponent");
...
const getContentComponent = (section) => {
    switch (section) {
        case "summary":
            return [React.createElement(MetricsSummarySectionComponent_1.MetricsSummarySectionComponent, null), React.createElement(antd_1.Space, { direction: "horizontal" },
        ...
        default:
            return [React.createElement(MetricsCanisterSectionComponent_1.MetricsCanisterSectionComponent, { canisterId: section }), React.createElement(antd_1.Space, { direction: "horizontal" },
...
const CanistergeekMetricsPage = () => {
    ...
    const routeMatch = (0, react_router_dom_1.useRouteMatch)(urlPathContext.metricsPath);
    ...
    if (!canisterIdInURLValid) {
        return React.createElement(react_router_dom_1.Redirect, { to: urlPathContext.pathToMetricsSection("summary") });
    }
    const [contentComponent, refreshComponent] = getContentComponent(canisterIdInURL);
    return React.createElement(React.Fragment, null,
        React.createElement(antd_1.PageHeader, { title: `${Constants_1.PRODUCT_NAME}: Metrics`, extra: refreshComponent }),
...
exports.CanistergeekMetricsPage = CanistergeekMetricsPage;
//# sourceMappingURL=CanistergeekMetricsPage.js.map