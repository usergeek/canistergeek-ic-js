...
exports.CanisterForceCollectMetricsButtonComponent = void 0;
...
const CanisterForceCollectMetricsButtonComponent = (props) => {
    var _a;
    ...
    const isMetricsSourceCanister = DashboardUtils_1.DashboardUtils.isMetricsSourceCanister(metricsSource);
    ...
    }, [dataContext.getCanisterMetrics, dataContext.collectCanisterMetrics, canisterId, metricsSource], (prevDeps, nextDeps) => lodash_1.default.isEqual(prevDeps, nextDeps));
...
exports.CanisterForceCollectMetricsButtonComponent = CanisterForceCollectMetricsButtonComponent;
//# sourceMappingURL=CanisterForceCollectMetricsButtonComponent.js.map