...
exports.MetricsCanisterSectionComponent = exports.CanisterSectionComponentBlackholeSource = exports.CanisterSectionComponentCanisterSource = void 0;
...
const CanisterSectionComponentCanisterSource = (props) => {
    ...
    const canisterLoaded = (_b = dataContext.status[canisterId]) === null || _b === void 0 ? void 0 : _b.loaded;
    ...
    const dataHourlyNotEmpty = !lodash_1.default.isNil(dataContext.dataHourly[canisterId]);
    const dataDailyNotEmpty = !lodash_1.default.isNil(dataContext.dataDaily[canisterId]);
    ...
    const canisterUpdateCallsAggregatedDataHourly = (_c = DataProviderUtils_1.DataProviderUtils.getDataHourlyMetrics(dataHourly, canisterId)) === null || _c === void 0 ? void 0 : _c.map(value => ({ timeMillis: value.timeMillis, values: value.updateCalls }));
    const canisterCyclesAggregatedDataHourly = (_d = DataProviderUtils_1.DataProviderUtils.getDataHourlyMetrics(dataHourly, canisterId)) === null || _d === void 0 ? void 0 : _d.map(value => ({ timeMillis: value.timeMillis, values: value.canisterCycles }));
    const canisterMemoryAggregatedDataHourly = (_e = DataProviderUtils_1.DataProviderUtils.getDataHourlyMetrics(dataHourly, canisterId)) === null || _e === void 0 ? void 0 : _e.map(value => ({ timeMillis: value.timeMillis, values: value.canisterMemorySize }));
    const canisterHeapMemoryAggregatedDataHourly = (_f = DataProviderUtils_1.DataProviderUtils.getDataHourlyMetrics(dataHourly, canisterId)) === null || _f === void 0 ? void 0 : _f.map(value => ({ timeMillis: value.timeMillis, values: value.canisterHeapMemorySize }));
...
const CanisterSectionComponentBlackholeSource = (props) => {
    ...
    const dataHourlyNotEmpty = !lodash_1.default.isNil(dataContext.dataBlackhole[canisterId]);
    const dataDailyNotEmpty = !lodash_1.default.isNil(dataContext.dataBlackhole[canisterId]);
    if (!dataHourlyNotEmpty && !dataDailyNotEmpty) {
        return React.createElement(antd_1.Result, { status: "warning", title: `No data.`, subTitle: React.createElement(React.Fragment, null, "Please check if you set the Blackhole canister as one of your canister's controller.") });
    }
...
const MetricsCanisterSectionComponent = (props) => {
    var _a;
    const canisterId = props.canisterId;
    const configurationContext = (0, ConfigurationProvider_1.useConfigurationContext)();
...
exports.MetricsCanisterSectionComponent = MetricsCanisterSectionComponent;
//# sourceMappingURL=MetricsCanisterSectionComponent.js.map