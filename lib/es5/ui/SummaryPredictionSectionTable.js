    ...
    return React.createElement(React.Fragment, null,
        React.createElement(antd_1.Table, { dataSource: precalculatedDataArray, pagination: { hideOnSinglePage: true, defaultPageSize: 20 }, size: "small", rowKey: record => record.canister.canisterId, loading: inProgress },
            React.createElement(antd_1.Table.Column, { title: "Canister", width: "16%", key: "Canister", render: (text, record) => {
                    ...
                    return React.createElement(react_router_dom_1.Link, { to: urlPathContext.pathToMetricsSection(record.canister.canisterId) },
                        React.createElement("span", { style: { fontSize: "1em", fontWeight: "bold" } }, canisterName));
                } }),
            React.createElement(antd_1.Table.Column, { title: "Cycles will run out in", width: "28%", key: "Cycles", render: (text, record) => React.createElement(SummaryPredictionSectionTableCellComponent_1.SummaryPredictionSectionTableCellComponent, { data: record.data.predictionData.cycles, metric: "cycles", differenceTitlePostfix: " cycles" }) }),
            React.createElement(antd_1.Table.Column, { title: "Canister will run out of memory in", width: "28%", key: "Memory", render: (text, record) => React.createElement(SummaryPredictionSectionTableCellComponent_1.SummaryPredictionSectionTableCellComponent, { data: record.data.predictionData.memory, metric: "memory", differenceTitlePostfix: " bytes" }) }),
