...
const ConfigurationPage = () => {
    ...
    const [textareaHasValidJSON, setTextareaHasValidJSON] = (0, react_1.useState)(() => {
        const { valid } = ConfigurationValidator_1.ConfigurationValidator.validateConfiguration(textareaValue);
        return valid;
    });
    const [textareaValidationError, setTextareaValidationError] = (0, react_1.useState)(() => {
        const { error } = ConfigurationValidator_1.ConfigurationValidator.validateConfiguration(textareaValue);
        return error;
    });
    const onChange = (0, react_1.useCallback)((value) => {
        const { valid, error } = ConfigurationValidator_1.ConfigurationValidator.validateConfiguration(value);
    ...
    const errorMessage = textareaValidationError ? textareaValidationError.message : null;
    const exampleButton = textareaValue.length == 0 ?
        React.createElement(antd_1.Button, { onClick: onClickExample }, "Example") :
        React.createElement(antd_1.Popconfirm, { title: "Are you sure to overwrite configuration with example?", onConfirm: onClickExample, okText: "Yes", okButtonProps: { type: "default" }, cancelText: "No", cancelButtonProps: { type: "primary" }, placement: "topRight" },
            React.createElement(antd_1.Button, null, "Example"));
    return React.createElement(React.Fragment, null,
        React.createElement(antd_1.PageHeader, { title: `${Constants_1.PRODUCT_NAME}: Settings` }),
        React.createElement(PageContent_1.PageContent, null,
            ...
            React.createElement(PageContent_1.PageContent.Card, null,
                ...
                React.createElement(antd_1.Space, { direction: "vertical", style: { width: "100%" } },
                    ...
                    React.createElement(antd_1.Row, { align: "middle", gutter: 16 },
                        ...
                        React.createElement(antd_1.Col, { style: { color: "red" } }, errorMessage),
                        React.createElement(antd_1.Col, { flex: "auto" },
                            React.createElement(antd_1.Row, { justify: "end" },
                                React.createElement(antd_1.Col, null, exampleButton)))))),
            React.createElement(PageContent_1.PageContent.CardSpacer, null),
            React.createElement(PageContent_1.PageContent.Card, null,
